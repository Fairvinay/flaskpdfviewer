 ...
 */
 ...
 class Modal   {
    ...
    constructor(props) {
     ...
     this.getInstance = function(emel) { return this.element;  } 
   ...
   static getInstance (emel) { return self;  } 
...
<div class="modal-dialog ${this.props.modalDialogClass}" role="document">
    ...
    show() {
        if (!this.element) {
            ...
            const modalInstance = bootstrap.Modal.constructor.getInstance(this.element)
            if (modalInstance) {
                modalInstance.show()
            }
        }
...
//let props = {} ;
//let bootstrap.Modal = new Modal(props);
let i = 0
...
bootstrap.showConfirm = (props) => {
    ...
    props.onCreate = (modal) => {
        const modalInstance = bootstrap.Modal.constructor.getInstance(modal.element)
